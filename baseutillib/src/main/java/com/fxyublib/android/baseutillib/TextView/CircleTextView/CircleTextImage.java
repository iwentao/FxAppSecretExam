...
public class CircleTextImage extends ImageView {
    ...
    private int mUseIndexBackgroundColor = -1;//Use random background color
    ...
    private static final float DEFAULT_TEXT_SIZE_RATIO = 0.2f;//0.4f;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mUseIndexBackgroundColor = typedArray.getInt(R.styleable.circletextview_index_color, -1);
    ...
    private void init() {
        ...
        if(mUseIndexBackgroundColor >= 0) {
            mPaint.setColor(Color.parseColor(CircleTextImageUtil.getInstance().getIndexColor(mUseIndexBackgroundColor)));
        } else if (mUseRandomBackgroundColor) {
    ...
    public void setIndexColor(int index) {
        this.mUseIndexBackgroundColor = index;
