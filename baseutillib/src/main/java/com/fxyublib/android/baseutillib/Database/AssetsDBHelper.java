package com.fxyublib.android.baseutillib.Database;
...
public class AssetsDBHelper {
    ...
    // Singleton Pattern
    private static AssetsDBHelper mInstance = null;
    ...
    public static void initManager(Context context){
        if(mInstance == null){
            mInstance = new AssetsDBHelper(context);
        }
    }
     ...
     */
    public static AssetsDBHelper getManager(){
        return mInstance;
    }

    private AssetsDBHelper(Context context){
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        SharedPreferences dbs = context.getSharedPreferences(AssetsDBHelper.class.toString(), 0);
