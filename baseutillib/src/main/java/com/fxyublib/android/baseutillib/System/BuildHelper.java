...
public class BuildHelper {
    ...
    public static String getShortBuildInformation(Context context) {
        String buildInfo = "";
        buildInfo += "VER:" + Build.MANUFACTURER +"," + Build.MODEL + "," + Build.VERSION.RELEASE + "(" + Build.VERSION.SDK + ")\n\n";
        buildInfo += "ID:" + DeviceId.getAndroidID(context) + "," + Build.SERIAL + "\n\nMAC:" + getMacAddress();
        return buildInfo;
    }
